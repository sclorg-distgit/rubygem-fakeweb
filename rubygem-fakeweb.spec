...
Patch1: rubygem-fakeweb-1.3.0-ruby-2-tests-fix.patch
...
%changelog
* Fri Mar 21 2014 Vít Ondruch <vondruch@redhat.com> - 1.3.0-12
- Rebuid against new scl-utils to depend on -runtime package.
  Resolves: rhbz#1069109

* Wed Feb 05 2014 Josef Stribny <jstribny@redhat.com> - 1.3.0-11
- Revert -doc license change since we remove the setup.rb in install

* Mon Feb 03 2014 Josef Stribny <jstribny@redhat.com> - 1.3.0-10
- Fix license for -doc subpackage

* Thu Nov 28 2013 Josef Stribny <jstribny@redhat.com> - 1.3.0-9
- Get rid of patch leftovers
- Fix changelog
